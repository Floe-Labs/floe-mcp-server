...
export function registerAllTools(server: McpServer, client: FloeApiClient) {
  ...
  server.tool('get_agent_reputation',
    'Return the calling agent\'s behavioral reputation: a 0-100 score, the resulting collateral-requirement multiplier (bps; 10000 = 1.0x baseline, lower score = higher multiplier), the feature breakdown, and sampleSize. Use to understand how much collateral the next borrow will require, and which behaviors improve standing. Returns 404 until the first score is computed.',
    {},
